...
do_build_bin(){
    ...
    org_custom_pkgs="luci-i18n-base-zh-cn -kmod-usb-core -kmod-usb2 -kmod-usb-ohci -kmod-usb-ledtrig-usbport luci-i18n-firewall-zh-cn libustream-openssl ca-bundle ca-certificates wget curl librt openssl-util vsftpd openssh-sftp-server -dnsmasq dnsmasq-full"
