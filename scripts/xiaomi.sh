...
# vlmcsd                          	vlmcsd for OpenWRT
    ...
    ## sysupgrade
    stuart_sysupgrade_pkgs="$stuart_factory_pkgs vlmcsd luci-app-vlmcsd luci-i18n-vlmcsd-zh-cn luci-app-ipsec-vpnd luci-i18n-ipsec-vpnd-zh-cn sqm-scripts luci-app-sqm luci-app-ssr-plus"
