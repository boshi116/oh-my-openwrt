...
cp -r ~/oh-my-openwrt-devices/packages/all/openwrt-dist/*.ipk ~/openwrt-imagebuilder-xiaomi/packages/stuart
cp -r ~/oh-my-openwrt-devices/packages/xiaomi/openwrt-dist/*.ipk ~/openwrt-imagebuilder-xiaomi/packages/stuart
