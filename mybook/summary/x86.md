...
# update
cd ~/oh-my-openwrt && git fetch origin master
...
# update
cd ~/oh-my-openwrt-devices && git fetch origin devices
...
CUSTOM_ORG_PKGS="luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn luci-app-ddns luci-i18n-ddns-zh-cn luci-app-adblock luci-i18n-adblock-zh-cn luci-app-sqm luci-app-uhttpd luci-ssl-openssl ca-bundle ca-certificates curl wget"
CUSTOM_PKGS="luci-app-ramfree"
IMAGE_PKGS="$ORG_ORIGIN_PKGS $CUSTOM_ORG_PKGS $CUSTOM_PKGS"
CON_FILES="~/oh-my-openwrt-devices/devices/x86"

make image PROFILE=Generic PACKAGES="$IMAGE_PKGS" FILES="$CON_FILES"
