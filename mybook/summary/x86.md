...
cp -r ~/oh-my-openwrt-devices/packages/all/*.ipk ~/openwrt-imagebuilder-x86/packages/stuart
...
CUSTOM_ORG_PKGS="luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn luci-app-ddns luci-i18n-ddns-zh-cn luci-app-adblock luci-i18n-adblock-zh-cn luci-app-sqm luci-app-uhttpd luci-i18n-uhttpd-zh-cn luci-ssl-openssl ca-bundle ca-certificates curl wget vsftpd openssh-sftp-server ipset iptables-mod-nat-extra -dnsmasq dnsmasq-full"
