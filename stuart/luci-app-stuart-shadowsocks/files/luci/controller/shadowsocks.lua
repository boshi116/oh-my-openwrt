...
function index()
	...
	entry({"admin", "stuart", "shadowsocks"},
		alias("admin", "stuart", "shadowsocks", "general"),
		_("ShadowSocks"), 10).dependent = true

	entry({"admin", "stuart", "shadowsocks", "general"},
		cbi("shadowsocks/general"),
		_("General Settings"), 10).leaf = true

	entry({"admin", "stuart", "shadowsocks", "status"},
		call("action_status")).leaf = true

	entry({"admin", "stuart", "shadowsocks", "servers"},
	...
	entry({"admin", "stuart", "shadowsocks", "access-control"},
