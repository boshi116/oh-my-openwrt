...
function index()
    ...
    page = entry({"admin", "stuart", "fileassistant"}, template("filebrowser_mini"), _("文件助手"), 2)
    page.i18n = "base"
    page.dependent = true

    page = entry({"admin", "stuart", "fileassistant_list"}, call("filebrowser_list"), nil)
    page.leaf = true

    page = entry({"admin", "stuart", "fileassistant_open"}, call("filebrowser_open"), nil)
    page.leaf = true

    page = entry({"admin", "stuart", "fileassistant_delete"}, call("filebrowser_delete"), nil)
    page.leaf = true

    page = entry({"admin", "stuart", "fileassistant_rename"}, call("filebrowser_rename"), nil)
    page.leaf = true

    page = entry({"admin", "stuart", "fileassistant_upload"}, call("filebrowser_upload"), nil)
    page.leaf = true
