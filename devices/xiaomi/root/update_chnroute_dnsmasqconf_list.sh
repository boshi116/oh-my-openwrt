...
wget -O- "https://stuarthua.github.io/gfwlist/dnsmasq_gfwlist_ipset.conf" -O /tmp/dnsmasq_gfwlist_ipset.conf && mv /tmp/dnsmasq_gfwlist_ipset.conf /etc/dnsmasq.d/dnsmasq_gfwlist_ipset.conf
